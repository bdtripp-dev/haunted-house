...
public class GameController {
     ...
     *
     * <p>
     * This endpoint initializes the game world, creates a new player state, and returns the initial
     ...
     *
     * <p>
     * The client sends a textual command (e.g., "go north", "take key", "look") and receives the
     * resulting game output and updated game status. Commands are interpreted by the game engine
